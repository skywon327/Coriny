...
public class block_member extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayList<String> items = new ArrayList<>(Arrays.asList("최원호", "김류림"));
        // CustomAdapter 클래스를 사용하여 ListView에 항목을 표시할 어댑터를 생성합니다.
        block_member.CustomAdapter adapter = new block_member.CustomAdapter(this, 0, items);
            ...
            final String text = items.get(position);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        list_frame.removeView(list_frame);
                    }
                });
